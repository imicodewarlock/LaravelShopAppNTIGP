...
<head>
    <meta charset="utf-8">
    <title>DASHMIN - @yield('title') - @yield('subTitle')</title>
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        ...
                        <span>{{ Session::get('user.role') }}</span>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('users.index') }}" class="nav-item nav-link {{ request()->routeIs('users.index') ? 'active' : '' }}"><i class="fa fa-users me-2"></i>Users</a>
                    <a href="{{ route('product-categories.index') }}" class="nav-item nav-link {{ request()->routeIs('product-categories.index') ? 'active' : '' }}"><i class="fa fa-leaf me-2"></i>Product Categories</a>
                    <a href="{{ route('products.index') }}" class="nav-item nav-link {{ request()->routeIs('products.index') ? 'active' : '' }}"><i class="fa fa-leaf me-2"></i>Products</a>
