            ...
            <div class="bg-light rounded h-100 p-4">
                ...
                <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="inputProductName" name="productName" value="{{ $product->name }}" aria-describedby="productNameHelp">
                        {{-- <div id="productNameHelp" class="form-text">The name that will be displayed.</div> --}}
                    </div>
                    <div class="mb-3">
                        <label for="inputProductDescription" class="form-label">Description</label>
                        <input type="text" class="form-control" id="inputProductDescription" name="productDesc" value="{{ $product->description }}" aria-describedby="productDescriptionHelp">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="inputProductPrice" name="productPrice" value="{{ $product->price }}" aria-label="Amount (to the nearest dollar)">
                    ...
                    <div class="mb-3">
                        <img id="inputProductPreview" class="img-preview" src="/storage/images/products/{{ $product->photo }}" alt="Image Preview" style="display: block;">
                    </div>
